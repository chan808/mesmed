...
public enum MaterialErrorCode implements ErrorCode {
    ...
    INVALID_STATUS_TRANSITION(400, "허용되지 않는 LOT 상태 전이입니다."),
    MATERIAL_ALREADY_DELETED(409, "이미 삭제된 원자재입니다."),
    LOT_ALREADY_DELETED(409, "이미 삭제된 LOT입니다."),
    SPEC_ALREADY_SUPERSEDED(409, "이미 개정 또는 삭제된 검사기준입니다.");
